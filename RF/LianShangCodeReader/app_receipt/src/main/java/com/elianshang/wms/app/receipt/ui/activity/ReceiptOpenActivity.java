 ...
 */
public class ReceiptOpenActivity extends DLBasePluginActivity implements ScanManager.OnBarCodeListener, ScanEditTextTool.OnStateChangeListener, View.OnClickListener {
...
//        submitButton.setClickable(false);
    ...
    private class RequestGetOrderInfoTask extends HttpAsyncTask<ReceiptInfo> {
        ...
        public DataHull<ReceiptInfo> doInBackground() {
            return ReceiptInfoProvider.request(orderOtherId, containerId, barCode);
        }
