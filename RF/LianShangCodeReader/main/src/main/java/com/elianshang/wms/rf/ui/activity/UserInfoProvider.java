...
public class UserInfoProvider {
    ...
    public static DataHull<User> request(String userName, String passwd) {
        ...
        headers.add(new DefaultKVPBean(UserInfoProvider.app_key, ""));
        headers.add(new DefaultKVPBean(UserInfoProvider.platform, ""));
        headers.add(new DefaultKVPBean(UserInfoProvider.version, ""));
        headers.add(new DefaultKVPBean(UserInfoProvider.api_version, ""));

        List<BaseKVP> params = new ArrayList<>();
        params.add(new DefaultKVPBean(UserInfoProvider.userName, userName));
        params.add(new DefaultKVPBean(UserInfoProvider.passwd, passwd));
