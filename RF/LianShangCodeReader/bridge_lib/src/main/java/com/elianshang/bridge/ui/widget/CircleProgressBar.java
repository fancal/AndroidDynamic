...
package com.elianshang.bridge.ui.widget;
...
public class CircleProgressBar extends ImageView {
    ...
    private static final int STROKE_WIDTH_LARGE = 4;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mProgressColor = a.getColor(R.styleable.CircleProgressBar_mlpb_progress_color, 0xff5C6BC0);
