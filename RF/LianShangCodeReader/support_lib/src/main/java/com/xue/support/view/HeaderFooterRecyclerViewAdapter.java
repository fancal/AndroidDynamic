...
public class HeaderFooterRecyclerViewAdapter<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public HeaderFooterRecyclerViewAdapter(T base) {
        super();
        mBase = base;
    }
    ...
    List<View> getFooters() {
        return mFooters;
    }

    void copyHeaders(List<View> headers) {
        mHeaders.clear();
        mHeaders.addAll(headers);
    }

    void copyFooters(List<View> headers) {
        mFooters.clear();
        mFooters.addAll(headers);
    }
