            ...
            mViewUpdateHandler = new Handler() {
                ...
                public void handleMessage(Message msg) {
                    ...
                    if (mProgressNumberFormat != null) {
                        ...
                        String progressText = twoDecimalPlaces(progress * 1.0f / (1024 * 1024));
                        String maxText = twoDecimalPlaces(max * 1.0f / (1024 * 1024));
                        mProgressNumber.setText(String.format(format, progressText, maxText));
                    } else {
