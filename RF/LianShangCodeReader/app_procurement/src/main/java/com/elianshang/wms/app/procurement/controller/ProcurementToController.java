...
import com.elianshang.wms.app.procurement.provider.ScanToLocationProvider;
...
public class ProcurementToController extends BaseProcurementController {
    ...
    public ProcurementToController(Activity activity, String taskId, String uId, ProcurementView procurementView, TaskTransferDetail detail) {
    ...
    private class RequestTransferTask extends HttpAsyncTask<ResponseState> {
        ...
        public DataHull<ResponseState> doInBackground() {
            return ScanToLocationProvider.request(taskId, locationId, uId, qty);
        }
