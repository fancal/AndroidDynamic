...
public class ScanLocationProvider {
    ...
    public static DataHull<ProcurementNext> request(Context context, String uId, String uToken, String type, String taskId, String locationId, String uomQty, String serialNumber) {
