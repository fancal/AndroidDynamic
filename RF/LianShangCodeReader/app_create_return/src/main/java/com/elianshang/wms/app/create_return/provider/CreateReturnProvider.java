...
public class CreateReturnProvider {
    ...
    public static DataHull<ResponseState> request(String locationId, String barCode, String uomQty, String uId) {
        ...
        params.add(new DefaultKVPBean(CreateReturnProvider.uId, uId));
